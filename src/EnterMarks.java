...
//         image.setBounds(470, 70, 400, 250);
//         add(image);
...
//         lblrollnumber.setBounds(50, 110, 200, 30);
//         add(lblrollnumber);

//         crollno = new Choice();
//         crollno.setBounds(250, 115, 150, 10);
//         add(crollno);
...
//         cbsemester.setBounds(250, 155, 150, 20);
//         cbsemester.setBackground(Color.WHITE);
//         add(cbsemester);

//         JLabel lblentersubject = new JLabel("Enter Marks");
//         lblentersubject.setBounds(300, 200, 200, 30);
//         add(lblentersubject);

//         JLabel lblentermarks = new JLabel("Enter Subject");
//         lblentermarks.setBounds(70, 200, 200, 30);
//         add(lblentermarks);

//         tfsub1 = new JTextField();
//         tfsub1.setBounds(40, 230, 200, 20);
//         add(tfsub1);

//         tfsub2 = new JTextField();
//         tfsub2.setBounds(40, 260, 200, 20);
//         add(tfsub2);

//         tfsub3 = new JTextField();
//         tfsub3.setBounds(40, 290, 200, 20);
//         add(tfsub3);

//         tfsub4 = new JTextField();
//         tfsub4.setBounds(40, 320, 200, 20);
//         add(tfsub4);

//         tfsub5 = new JTextField();
//         tfsub5.setBounds(40, 350, 200, 20);
//         add(tfsub5);

//         tfmarks1 = new JTextField();
//         tfmarks1.setBounds(240, 230, 200, 20);
//         add(tfmarks1);

//         tfmarks2 = new JTextField();
//         tfmarks2.setBounds(240, 260, 200, 20);
//         add(tfmarks2);

//         tfmarks3 = new JTextField();
//         tfmarks3.setBounds(240, 290, 200, 20);
//         add(tfmarks3);

//         tfmarks4 = new JTextField();
//         tfmarks4.setBounds(240, 320, 200, 20);
//         add(tfmarks4);

//         tfmarks5 = new JTextField();
//         tfmarks5.setBounds(240, 350, 200, 20);
//         add(tfmarks5);
...
//         cancel.setBounds(280, 380, 120, 30);
